...
public class EjempoAutomovil {
    public static void main(String[] args) {
        ...
        System.out.println("Kilometros mor litro: " + subaru.calcularConsumo( 300, 0.5f));
        System.out.println("Kilometros mor litro: " + subaru.calcularConsumo( 300, 60));        System.out.println("Kilometros mor litro: ");
        System.out.println("Kilometros mor litro: " + nissan.calcularConsumo( 300, 60));    }
}
